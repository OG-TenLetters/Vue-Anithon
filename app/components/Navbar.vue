...
<template>
  ...
  >
    <NuxtLink to="/">
      <AnithonLogo
        class="ml-15 cursor-pointer transition-all duration-150 hover:brightness-90"
      />
    </NuxtLink>
    <div class="relative">
      <input
    ...
    <div class="flex items-center gap-x-4">
      ...
      <div class="relative">
        ...
        <ul class="bg-black absolute right-0 flex flex-col gap-y-3 py-4 px-6 rounded-xl text-white text-sm">
          <li>Random</li>
          <li>Random</li>
          <li>Random</li>
          <li>Random</li>
